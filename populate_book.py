...
# Poetry Books
genre1 = Genre(user_id=1, name="Poetry",
               description="Poetry is an art form in which human language is used for its aesthetic qualities in addition to, or instead of, its notional and semantic content.")
...
# Fantasy books
genre2 = Genre(user_id=1, name="Fantasy",
               description="Fantasy is a genre of fiction set in a fictional universe, often, but not always, without any locations, events, or people referencing the real world.")
...
# Children books
genre4 = Genre(user_id=1, name="Children's",
               description="Children's literature or juvenile literature includes stories, books, magazines, and poems that are enjoyed by children.")
...
genre5 = Genre(user_id=1, name="History",
               description="Historical fiction is a literary genre in which the plot takes place in a setting located in the past. ")
